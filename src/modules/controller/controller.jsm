 ...
 * @this {Controller}
 */
zimbra_notifier_Controller._init = function() {
    if (this._service === null) {
        this._service = new zimbra_notifier_Service(this);
    }

    if (this._systray === null && zimbra_notifier_Prefs.isSystrayEnabled()) {
        Components.utils.import("resource://zimbra_mail_notifier/service/systray.jsm");
        this._systray = new zimbra_notifier_Systray();
 ...
 * @this {Controller}
 * @param {Object}
 *            callback Object which has this function : refresh(event)
 */
