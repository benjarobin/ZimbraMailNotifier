...
zimbra_notifier_Prefs.PREF = {
    ...
    SYSTRAY_ENABLED                       : "systrayEnabled",
...
zimbra_notifier_Prefs.observe = function(subject, topic, data) {
    ...
    switch (data) {
        ...
        case this.PREF.SYSTRAY_ENABLED:
            this.pref_systray_enabled = this._getPref(data);
            break;
 ...
 * @return {Boolean} true if enabled
 */
zimbra_notifier_Prefs.isSystrayEnabled = function() {
